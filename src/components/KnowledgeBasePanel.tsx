...
export default function KnowledgeBasePanel(props: KnowledgeBasePanelProps) {
  ...
  return (
    <div class="modal-overlay" onClick={props.onClose}>
      <div class="modal list-modal" style="min-width:560px;max-width:680px;" onClick={(e) => e.stopPropagation()}>
        ...
        {error() && (
          <div style="padding:8px 22px;background:rgba(239,68,68,0.08);color:var(--clr-danger);font-size:13px;">
            {error()}
          </div>
        )}
        ...
        {showEmbeddingConfig() ? (
          <>
            <div style="padding:14px 22px;border-bottom:1px solid var(--clr-border);display:flex;align-items:center;gap:10px;">
          ...
          <>
            <div style="padding:14px 22px;border-bottom:1px solid var(--clr-border);display:flex;align-items:center;justify-content:space-between;">
              <span style="display:flex;align-items:center;gap:8px;">
            ...
            {showCreateForm() && (
              <div style="padding:16px 22px;border-bottom:1px solid var(--clr-border);">
                <div class="form-group">
                  <label>名称</label>
                  <input
                    type="text"
