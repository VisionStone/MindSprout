...
|------|-------|--------------|
| Primary | `#8B5CF6` | `--clr-primary` |
| Secondary | `#A78BFA` | `--clr-secondary` |
| Accent | `#F472B6` | `--clr-accent` |
| Background | `#F5F3FF` | `--clr-background` |
| Text | `#1E1B4B` | `--clr-text` |
| Surface | `rgba(255,255,255,0.6)` | `--clr-surface` |
| Border | `rgba(255,255,255,0.3)` | `--clr-border` |
| Muted | `#C4B5FD` | `--clr-muted` |

**Color Notes:** Frosted glass effects with backdrop blur. Layered depth creates a premium, modern feel.

### Typography

- **Heading Font:** Inter + Plus Jakarta Sans
- **Body Font:** Inter + Plus Jakarta Sans
- **Mood:** modern, ethereal, depth, layered
